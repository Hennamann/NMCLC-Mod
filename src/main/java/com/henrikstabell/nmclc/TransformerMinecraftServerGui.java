        ...
        if (transformedName.equals(TARGET_INNER_CLASS)) {
            ...
            for (MethodNode method : cnode.methods) {
                if (method.name.equalsIgnoreCase(TARGET_METHOD)) {
                    ...
                    method.visitLineNumber(44, l5);
                    method.visitVarInsn(Opcodes.ALOAD, 4);
                    method.visitVarInsn(Opcodes.ASTORE, 2);
                    method.visitLabel(l3);
                    method.visitLineNumber(46, l3);
                    ...
                    Label l6 = new Label();
                    method.visitJumpInsn(Opcodes.IFLE, l6);
                    Label l7 = new Label();
                    method.visitLabel(l7);
                    method.visitLineNumber(47, l7);
                    method.visitVarInsn(Opcodes.ALOAD, 0);
                    ...
                    method.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/lang/String", "trim", "()Ljava/lang/String;", false);
                    method.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/lang/String", "toLowerCase", "()Ljava/lang/String;", false);
                    method.visitMethodInsn(Opcodes.INVOKESTATIC, "net/minecraft/server/MinecraftServer", obf ? "func_71276_C" : "getServer", "()Lnet/minecraft/server/MinecraftServer;", false);
                    ...
                    method.visitLineNumber(51, l8);
                    method.visitInsn(Opcodes.RETURN);
                    Label l9 = new Label();
                    method.visitLabel(l9);
                    method.visitLocalVariable("lowerCapsMsg", "Ljava/lang/String;", null, l5, l3, 4);
                    method.visitLocalVariable("this$0", "Lnet/minecraft/server/gui/MinecraftServerGui$2;", null, l0, l9, 0);
